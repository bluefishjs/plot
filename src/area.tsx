...
export type AreaProps<T> = Omit<JSX.LineSVGAttributes<SVGLineElement>, "x" | "y" | "fill" | "width" | "height"> & {
  name: Id;
  x: Encoding<T>;
  dx?: Encoding<T>;
  y: Encoding<T>;
...
export const Area = withBluefish((props: AreaProps<any>) => {
  ...
  const d = createMemo(() => line().curve(curveCatmullRom)(lineData()) ?? "");
